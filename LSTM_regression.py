...
#from laoshi data
tr_x_s = np.load("/media/lab/办公/extract data Rodrigo/Rodrigo/laoshi_data/MPL_extracion/200_s_tr_x.npy")
tr_x_v = np.load("/media/lab/办公/extract data Rodrigo/Rodrigo/laoshi_data/MPL_extracion/200_v_tr_x.npy")
train_x = np.append(tr_x_s, tr_x_v, axis=1)
te_x_s = np.load("/media/lab/办公/extract data Rodrigo/Rodrigo/laoshi_data/MPL_extracion/200_s_te_x.npy")
te_x_v = np.load("/media/lab/办公/extract data Rodrigo/Rodrigo/laoshi_data/MPL_extracion/200_v_te_x.npy")
