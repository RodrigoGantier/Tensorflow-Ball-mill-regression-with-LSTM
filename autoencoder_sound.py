...
train_x =train_x[:, 5, :, :].reshape([-1,550]) 
test_x = test_x[:, 5, :, :].reshape([-1,550])
...
with tf.Session() as sess:
    ...
    np.save('/media/lab/办公/extract data Rodrigo/Rodrigo/laoshi_data/extraccion/200_enc_s_train_x.npy', train_x)
    np.save('/media/lab/办公/extract data Rodrigo/Rodrigo/laoshi_data/extraccion/200_enc_s_test_x.npy', test_x)
