...
#from laoshi data
tr_x_s = np.load("/media/lab/办公/extract data Rodrigo/Rodrigo/laoshi_data/extraccion/200_enc_s_train_x.npy")
tr_x_v = np.load("/media/lab/办公/extract data Rodrigo/Rodrigo/laoshi_data/extraccion/200_enc_v_train_x.npy")
train_x = np.append(tr_x_s, tr_x_v, axis=1)
te_x_s = np.load("/media/lab/办公/extract data Rodrigo/Rodrigo/laoshi_data/extraccion/200_enc_s_test_x.npy")
te_x_v = np.load("/media/lab/办公/extract data Rodrigo/Rodrigo/laoshi_data/extraccion/200_enc_v_test_x.npy")
test_x = np.append(te_x_s, te_x_v, axis=1)
