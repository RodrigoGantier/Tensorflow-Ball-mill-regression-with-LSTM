...
np.save('/media/lab/办公/extract data Rodrigo/Rodrigo/laoshi_data/MPL_extracion/200_s_tr_x.npy',train_x)
np.save('/media/lab/办公/extract data Rodrigo/Rodrigo/laoshi_data/MPL_extracion/200_s_te_x.npy', test_x)
